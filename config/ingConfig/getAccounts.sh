...
METHOD="GET"
PATHWITHOUTQUERY="/v1/accounts"
QUERY="grant_type=authorization_code&code=694d6ca9-1310-4d83-8dbb-e819c1ee6b80&redirect_uri=xxx"
...
pathWithQuery="$PATHWITHOUTQUERY"
