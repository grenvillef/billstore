...
var postInvoiceApi={
	...
	return db.query("insert into Invoices(CustomerId,InvoiceNumber,InvoiceDate, SubTotalAmount, CurrencyCode, InvoiceStatus, StoreId, TotalShippingPrice, TotalAmount, TotalTaxAmount, BarCode, RefundByDate) Values ('0000000003', NOW(), 150.00, 'EUR', 'PAID', '1',10.00,140.00, 21.00, '1234567890456', NOW() + INTERVAL 30 DAY", callback);
